...
- Migrate Android application from Google Maps SDK for Android to Amazon Location Service → [steering/google-migration-android.md](steering/google-migration-android.md)
- Migrate iOS application from Google Maps SDK for iOS to Amazon Location Service → [steering/google-migration-ios.md](steering/google-migration-ios.md)
- Migrate JavaScript web application from Google Maps API to Amazon Location Service → [steering/google-migration-web.md](steering/google-migration-web.md)
